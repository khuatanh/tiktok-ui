...
export const HomeIcon = ({ width = '3.2rem', height = '3.2rem', className, onClick }) => (
    <svg
        className={className}
        width={width}
        height={height}
...
export const UserActiveGroup = ({ width = '3.2rem', height = '3.2rem', className }) => (
    <svg
        className={className}
        width={width}
        height={height}
...
export const UserGroup = ({ width = '3.2rem', height = '3.2rem', className }) => (
    <svg
        className={className}
        width={width}
        height={height}
...
export const MusicIcon = ({ className, width = '1em', height = '1em' }) => (
    <svg
        className={className}
        width={width}
        height={height}
    ...
    <svg className={className} width={width} height={height} viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
        ...
        <defs>
            <radialGradient
                ...
                r="1"
                gradientUnits="userSpaceOnUse"
                gradientTransform="translate(11.1827 18.2553) rotate(R13.046) scale(8.93256 8.78076)"
            >
                <stop></stop>
...
export const PauseIcon = ({ className, width = '2.0rem', height = '2.0rem' }) => (
    <svg
        width={width}
        height={height}
        className={className}
...
export const PlayIcon = ({ className, width = '2.0rem', height = '2.0rem' }) => (
    <svg
        width={width}
        height={height}
        className={className}
...
export const SoundIconMute = ({ className, width = '2.0rem', height = '2.0rem' }) => (
    <svg
        width={width}
        dataR2e=""
        height={height}
...
export const SoundIconVolume = ({ className, width = '2.0rem', height = '2.0rem' }) => (
    <svg
        width={width}
        dataR2e=""
        height={height}
...
export const UploadIcon2 = ({ className, width = '2.0rem', height = '2.0rem' }) => (
    <svg
        className={className}
        width={width}
        height={height}
...
export const ShareIconInfo = ({ className, width = '2.4rem', height = '2.4rem' }) => (
    <svg
        width={width}
        height={height}
        className={className}
...
export const InfoMoreIcon = ({ className, width = '2.4rem', height = '2.4rem' }) => (
    <svg
        width={width}
        height={height}
        className={className}
...
export const PauseIconTrans = ({ className, width = '1.8rem', height = '1.8rem' }) => (
    <svg
        width={width}
        height={height}
        className={className}
...
export const UserNoVideoIcon = ({ className, width = '9rem', height = '9rem' }) => (
    <svg
        width={width}
        height={height}
        className={className}
...
export const PrivateIcon = ({ className, width = '9rem', height = '9rem' }) => (
    <svg
        width={width}
        height={height}
        className={className}
